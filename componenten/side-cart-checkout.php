         ...
         <div class="bg-white w-full lg:max-w-[464px]md:mt-[35px] lg:mt-[unset]">
                        ...
                        <div class="">
                            ...
                            if (!empty($cart)) {
                                foreach ($cart as $cart_item_key => $cart_item) {
                                    ...
                                    <div class="flex items-center w-full justify-between mt-[20px]">
                                        <!-- AFBEELDING -->
                                        <a href="<?php the_permalink($product->get_id());?>" class="rounded-[10px] w-[81px] h-[81px] lg:w-[90px] lg:h-[90px] overflow-hidden">
                                            <?php
                                            if ($product_image) {
                                            echo '<img class="min-w-full min-h-full object-cover object-center" src="' . esc_url($product_image[0]) . '" alt="' . esc_attr($product->get_name()) . '"/>';
                                            }
                                            ?>
                                        </a>
                                        <!-- INFORMATIE -->
                            ...
                            if (WC()->cart->get_cart_contents_count() > 0) { ?>
                             <div class="flex justify-between">
                                <p class="font-jakarta font-normal text-15 leading-30 text-[#525252]">Subtotaal</p>
                                <p class="font-jakarta font-normal text-15 leading-30 text-[#525252]">
                                    <?php $total = WC()->cart->get_cart_subtotal();
                                    echo '' . $total;
                                    ?>
                                </p>
                            </div>
                            ...
                            <div class="flex justify-between">
                                <p class="font-jakarta font-normal text-15 leading-30 text-[#525252]">Korting</p>
                                <p class="font-jakarta font-normal text-15 leading-30 text-[#525252]">
                            ...
                            <?php endforeach; ?>
                              ...
                              <div class="flex justify-between">
                                <p class="font-jakarta font-normal text-15 leading-30 text-[#525252]">Verzendkosten</p>
                                <p class="font-jakarta font-normal text-15 leading-30 text-[#525252]">
                                    <?php
                                    ...
                                    if ($verzendkosten >= 1) {
                                        ...
                                        echo '<span class="tetext-[#525252]">Gratis</span>';
                                    }
                                    ?>
                                </p>
                            </div>
                            <div class="flex justify-between">
                                <p class="font-jakarta font-bold text-15 leading-25 xl:text-16 xl:leading-25 text-[#525252]">Totaal</p>
                                <p class="font-jakarta font-bold text-15 leading-25 xl:text-16 xl:leading-25 text-[#525252]">
                                    <?php
