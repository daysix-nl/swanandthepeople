    ...
    <section class="bg-[#f9f9f9] py-[80px]">
        <div class="container flex flex-wrap lg:flex-nowrap justify-between">
            ...
            <div class="md:w-[243px] lg:w-[236px] xl:w-[257px] md:order-4 lg:order-3 hidden md:block md:mt-[50px] lg:mt-[unset]">
                <a href="/shop"><h3 class="font-normal text-22 leading-30 text-[#5D7365] mb-[20px]">Shop</h3></a>
                <div class="grid">
                    <?php
                    if( have_rows('menu_producten', 'option') ):
                        while( have_rows('menu_producten', 'option') ) : the_row(); ?>
                         <a href="<?php echo get_sub_field('menu_producten_link', 'option');?>" class="font-normal text-15 leading-30 text-[#525252] w-fit"><?php echo get_sub_field('menu_producten_titel', 'option');?></a>
                        <?php
                        endwhile;
                    else :
                    endif;
