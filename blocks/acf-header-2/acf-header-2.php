...
?>
<!-- CONTENT 3 -->
<section class="bg-[#f9f9f9] py-[60px]">
    <div class="w-[360px] md:w-[600px] lg:w-[800px] mx-auto">
        <h1 class="text-36 leading-36 text-[#5D7365] font-crimson font-normal text-center"><?php echo get_field('titel');?></h1>
        <?php if (get_field('subtitel')): ?> 
            <h2 class="text-22 leading-22 text-[#5D7365] font-crimson font-normal mt-[15px] text-center"><?php echo get_field('subtitel');?></h2>
        <?php endif; ?>
        <p class="text-14 leading-25 text-[#5D7365] mt-[20px] text-center"><?php echo get_field('tekst');?></p>
