...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
        ...
        <div class="flex w-full justify-between">
            <button id="add-to-cart" type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="h-[45px] bg-[#5D7365] rounded-[20px] font-jakarta font-bold text-white text-15 xl:text-16 w-full lg:w-[305px] xl:w-[370px] flex items-center justify-center">Voeg toe</button>
