...
?>
<div id="payment" class="woocommerce-checkout-payment paybox mt-[45px] bg-white">
	...
	<div class="w-full lg:max-w-[448px] block lg:hidden">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="checkout-button text-white" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">Afrekenen</button>' ); // @codingStandardsIgnoreLine ?>
